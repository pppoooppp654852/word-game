class Team {
  ...
  const teamsData = {
    1: new Team(
      ...
      100,
      [
        {id: 0, text: '火焰進攻 🔥：集結軍團對蒼翠王國發動猛烈攻擊，試圖摧毀他們的防禦工事。', count: 0},
    ...
    2: new Team(
      ...
      [
        ...
        {id: 2, text: '海怪襲擊 🐙：釋放海怪攻擊敵方的戰艦或邊境據點。', count: 0},
    ...
    3: new Team(
      ...
      [
        ...
        {id: 2, text: '軍備升級 ⚒️：強化士兵裝備，使他們擁有更高的戰力與防禦力。', count: 0},
    ...
    4: new Team(
      ...
      [
        ...
        {id: 3, text: '交易陰謀 💀：與任意陣營達成黑市交易，交換情報或資源。', count: 0}
      ]
    ),
  };
